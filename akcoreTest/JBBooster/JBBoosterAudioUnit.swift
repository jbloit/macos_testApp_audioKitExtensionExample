...
public class JBBoosterAudioUnit: AKAudioUnitBase {

    func setParameter(_ address: JBBoosterParameter, value: Double) {
        setParameterWithAddress(address.rawValue, value: Float(value))
    }

    func setParameterImmediately(_ address: JBBoosterParameter, value: Double) {
